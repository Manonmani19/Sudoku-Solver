...
# Total window
screen = pygame.display.set_mode((500, 617))

# Title and Icon
pygame.display.set_caption("SUDOKU SOLVER USING BACKTRACKING")
# img = pygame.image.load('C:\Users\dheer\Desktop\pythocobra\sudoku game\icon.png')
...
def draw_box():
    for i in range(2):
        ...
        pygame.draw.line(screen, (255, 0, 0), ((x + i) * dif, y *
                         dif), ((x + i) * dif, y * dif + dif), 7)
    ...
    for i in range(9):
        for j in range(9):
            if grid[i][j] != 0:
                ...
                pygame.draw.rect(screen, (190,100,221),
                                 (i * dif, j * dif, dif + 1, dif + 1))

                # Fill grid with default numbers specified
                text1 = font1.render(str(grid[i][j]), 1, (0, 0, 0))
                screen.blit(text1, (i * dif + 18, j * dif + 9))
...
def instruction():
    ...
    screen.blit(text1, (35, 520))
    screen.blit(text2, (22, 545))

# Display options when solved
def result():
    text1 = font1.render("FINISHED PRESS R or D", 1, (0, 0, 0))
    screen.blit(text1, (22, 570))
